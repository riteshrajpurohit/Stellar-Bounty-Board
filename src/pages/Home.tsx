        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="space-y-4">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
              The premier bounty board for the Stellar ecosystem. Connect your Freighter wallet to claim bounties, build reputation, and get paid instantly.
            </p>
          </div>
          ...
          <div className="pt-16 grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Smart contracts ensure you get paid the moment your work is approved.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Find high-impact tasks and build your decentralized portfolio.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Leverage the power of Stellar Soroban for verifiable bounty logic.</p>
            </div>
          </div>
        </div>
      ) : (
